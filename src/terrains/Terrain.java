...
public class Terrain {
	...
	public Terrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack, 
		...
		this.centerX = this.x + SIZE / 2;
		this.centerZ = this.z + SIZE / 2;
		this.model = generateTerrain(loader, gridX, gridZ, seed);
	}
	...
	public float getHeightOfTerrain(float worldX, float worldZ) {
		...
		return (xCoord <= (1 - zCoord)) ? 
				Maths.barryCentric(new Vector3f(0, heights[gridX][gridZ],     0), 
				...
				Maths.barryCentric(new Vector3f(1, heights[gridX + 1][gridZ],     0), 
								   new Vector3f(1, heights[gridX + 1][gridZ + 1], 1), 
								   new Vector3f(0, heights[gridX][gridZ + 1], 1), 
								   new Vector2f(xCoord, zCoord));
	}

	private RawModel generateTerrain(Loader loader, int gridX, int gridY, int seed) {
		int VERTEX_COUNT = 128;
		
		HeightsGenerator generator = new HeightsGenerator(gridX, gridY, VERTEX_COUNT, seed);
